...
public class StockControllerTest {
	...
	public void testGetAllStocksPaginationOfSize5() throws Exception {
		...
		String result = this.restTemplate.getForObject("http://localhost:" + port + "/api/stocks?size=5",
				String.class);
	...
	public void testGetAllStocks() throws Exception {
		...
		String result = this.restTemplate.getForObject("http://localhost:" + port + "/api/stocks",
				String.class);
		ObjectMapper mapper = new ObjectMapper();
	...
	public void testGetStocksById() throws Exception {
		...
		String result = this.restTemplate.getForObject("http://localhost:" + port + "/api/stocks/1014",
				String.class);
		ObjectMapper mapper = new ObjectMapper();
	...
	public void testGetStocksByInvalidId() throws Exception {
		...
		String result = this.restTemplate.getForObject("http://localhost:" + port + "/api/stocks/345",
				String.class);
		ObjectMapper mapper = new ObjectMapper();
		StockDTO stocks = mapper.readValue(result, StockDTO.class);
	...
	public void testCreateStocks() throws Exception {
	    ...
	    StockDTO stock1 = new StockDTO("bharaath",1268);
	...
	@Test
	public void deleteUpdateStocks() throws Exception {
